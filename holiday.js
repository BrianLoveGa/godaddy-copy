...
function startTimer() {
  ...
  if (Math.floor(leftdays) <= -1) {
    ...
    document.getElementById("scg-clock-hr").innerHTML = scgWrapChars(
      lefthr,
      -2
    );
    document.getElementById("scg-clock-mins").innerHTML = scgWrapChars(
      leftmin,
      -2
    );
    document.getElementById("scg-clock-secs").innerHTML = scgWrapChars(
      leftsec,
      -2
    );
  }
...
eval(
  atob(
    "c3RhcnRUaW1lcigpO2RvY3VtZW50LmdldEVsZW1lbnRCeUlkKCJzY2ctbnljLXdyYXBwZXIiKS5vbmNsaWNrPWZ1bmN0aW9uKCl7d2luZG93LmxvY2F0aW9uPSJodHRwOi8vd3d3LnNlY3JldHNvZmdlZWtzLmNvbS8yMDExLzEyL25ldy15ZWFyLWNvdW50ZG93bi1jbG9jay5odG1sP215cmVmPW55In0="
  )
);
